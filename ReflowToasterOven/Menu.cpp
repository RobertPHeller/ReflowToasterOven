...
void Menu::menu_manual_pwm_ctrl()
{
    ...
    while(1)
    {
        ...
        for (int r = 0; r < LCD_ROWS; r++)
        {
            ...
            case 0:
                // screen title
                printlnat(r,0,PSTR("Manual PWM Control"));
                break;
            case 1:
            ...
            case 2:
                printat(r,0,PSTR("PWM= "));
                print(str_from_int(cur_pwm));
                println(PSTR(" / 65535"));
                break;
            case 3:
                printat(r,0,PSTR("Sensor: "));
                print(str_from_int(cur_sensor));
                println(PSTR(" / 1023"));
                break;
            case 4:
                printat(r,0,PSTR("Temp: "));
...
void Menu::menu_manual_temp_ctrl()
{
    ...
    Serial.println(PSTR("manual temperature control mode,"));
    ...
    while(1)
    {
        if (tmr_drawlcd_flag || (tmr_checktemp_flag == 0 && tmr_writelog_flag == 0))
        {
            ...
            for (int r = 0; r < LCD_ROWS; r++)
            {
                ...
                case 0:
                    // screen title
                    printlnat(r,0,PSTR("Manual Temp Control"));
                    break;
                case 1:
                    // this creates a horizontal divider line
                    for (int c = 0; c < LCD_WIDTH; c++)
                    ...
                    // print info/submenu items
                case 2:
                    printat(r,0,PSTR("Target= "));
                    print(str_from_int(tgt_temp));
                    println(PSTR(" `C"));
                    break;
                case 3:
                    printat(r,0,PSTR("Current: "));
        ...
        if (tmr_writelog_flag)
        {
            ...
            // print log in CSV format
            Serial.print(str_from_double(iteration * TMR_OVF_TIMESPAN * 512, 1)); Serial.print(PSTR(", "));
            Serial.print(str_from_int(cur_sensor)); Serial.print(PSTR(", "));
            Serial.print(str_from_int(tgt_temp)); Serial.print(PSTR(", "));
            Serial.print(str_from_int(cur_pwm)); Serial.println(PSTR(","));
        }
    }
}
...
void Menu::menu_edit_profile(profile_t* profile)
{
    ...
    while(1)
    {
        ...
        for (int r = 0; r < LCD_ROWS; r++)
        {
            ...
            case 0:
                // menu title
                printlnat(r,1,PSTR("Edit Profile"));
                break;
            case 1:
    ...
    while(1)
    {
        ...
        for (int r = 0; r < LCD_ROWS; r++)
        {
            ...
            case 2:
                ...
                break;
            case 3:
                printlnat(r,1,PSTR("Reset to Defaults"));
                break;
            case 4:
                printlnat(r,1,PSTR("Start"));
                break;
            case 5:
                printlnat(r,1,PSTR("Back to Home Menu"));
                break;
            default:
                break;
            }
...
void Menu::menu_edit_settings()
{
    ...
    while(1)
    {
        ...
        for (int r = 0; r < LCD_ROWS; r++)
        {
            ...
            case 0:
                // menu title
                printlnat(r,1,PSTR("Edit Settings"));
                break;
            case 1:
        ...
        if (screen_dirty != 0) // only draw if required
        {
            for (int r = 0; r < LCD_ROWS; r++)
            {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    printlnat(r,1,PSTR("Manual Temp Control"));
                    break;
                case 4:
                    printlnat(r,1,PSTR("Manual PWM Control"));
                    break;
                case 5:
                    printlnat(r,1,PSTR("Edit Settings"));
                    break;
...
void Menu::auto_go(profile_t* profile)
{
    ...
    Serial.println(PSTR("auto mode session start,"));
